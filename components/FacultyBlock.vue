      ...
      >
        ...
        >
          <div class="faculty-card">
            <div class="faculty-star">
              <svg
                class="urok__header-background-right-g1"
                width="16"
                height="19"
                viewBox="0 0 32 35"
                fill="none"
              ...
              >
                <path
                  d="M16.0795 0.836427L16.0273 1.19392C14.7875 9.68664 8.63479 16.3476 0.790052 17.6898L0.459799 17.7463L0.790052 17.8027C8.63479 19.1449 14.7875 25.8059 16.0273 34.2986L16.0795 34.6561L16.1317 34.2986C17.3715 25.8059 23.5242 19.1449 31.369 17.8027L31.6992 17.7463L31.369 17.6898C23.5242 16.3476 17.3715 9.68664 16.1317 1.19392L16.0795 0.836427Z"
                  fill="#192b69"
                ></path>
              </svg>
            </div>
...
:deep(.swiper-slide-active) .faculty-star {
  opacity: 0.2;
}
